...
class InventoryCompareTest extends TestCase
{
    ...
    public function testSetFileInventoryItem()
    {
        ...
        $this->inventoryCompare->setFileInventoryItem("0", "aisle", "section", "shelf", "description", "size");
    ...
    public function testCompareInventorySetsInequalLocationMatch()
    {
        ...
        $this->inventoryCompare->setFileInventoryItem("0", "otherAisle", "section", "shelf", "description", "size");
